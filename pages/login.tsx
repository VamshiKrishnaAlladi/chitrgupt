...
export default function Login() {
    ...
    return (
        <div className="flex flex-col space-y-4 lg:flex-row lg:space-y-0 lg:space-x-12 h-screen items-center justify-center">
            <Head>
                <title>XP Man | Login</title>
                <link rel="icon" href="/favicon.ico" />
            </Head>

            <section className="min-w-max w-full flex flex-col my-4 p-4 text-center lg:text-right">
                <span className="text-4xl sm:text-6xl 2xl:text-7xl text-gray-800">XP Man</span>
                <span className="text-lg sm:text-2xl 2xl:text-3xl text-gray-800">Next-gen Expense Manager</span>
            </section>
